...
//        collectionView?.register(MensajesTableViewCell.self, forCellWithReuseIdentifier: cellId)
//        
...
//        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! MensajesTableViewCell
//        
...
//        
//        cell.txtLabel.text = message.text
//        
...
//    }
//    
//    fileprivate func setupCell(_ cell: MensajesTableViewCell, message: Message) {
...
//            //outgoing blue
//            cell.bubbleView.backgroundColor = MensajesTableViewCell.blueColor
